...
# below line should be modified to look like this
from netmiko.hp import HPProcurveSSH, HPProcurveTelnet, HPComwareSSH, HPComwareTelnet, HPComwareJinhuaSSH, HPComwareJinhuaTelnet, HPComware512900SSH, HPComware512900Telnet, HPComwareFoesSSH, HPComwareFoesTelnet
...
# below line should be added inside CLASS_MAPPER_BASE
...
# Add telnet drivers
# below line should be added below
